...
public class CarService {
    ...
    /**
     * Gets car information by ID (or throws com.udacity.pricing.exception if non-existent)
    ...
    public Car findById(Long id) {
         ...
         */
        Optional<Car> optionalCar = Optional.ofNullable(carRepository
                                                        .findById(id)
                                                        .orElseThrow(CarNotFoundException::new));
        Car car = optionalCar.get();
//        Car car = Optional.ofNullable(carRepository
//                                        .findById(id)
